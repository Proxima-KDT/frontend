            ...
            <Card className="rounded-3xl border border-[#e1ddd6] bg-[#f8f7f4] shadow-none">
              <div className="mb-4 flex items-center justify-end">
                <div className="flex items-center gap-2">
                  <span className="rounded-full bg-[#f0efeb] px-2.5 py-1 text-[11px] text-[#777267]">
                    Sort: Name
                  </span>
                  <span className="rounded-full bg-[#f0efeb] px-2.5 py-1 text-[11px] text-[#777267]">
                    Filter: All
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`text-xs font-semibold ${score < 70 ? 'text-[#b85b5b]' : 'text-[#505a66]'}`}
                        >
                          {score}%
                        </span>
                      </div>
                      <span
                        className={`inline-flex w-fit rounded-full px-2.5 py-1 text-xs font-semibold ${score < 70 ? 'bg-[#f3e8e8] text-[#944848]' : 'bg-[#e8eef5] text-[#3d5a6e]'}`}
                      >
                        {score < 70 ? '吏?먰븘?? : '?묓샇'}
                      </span>
                    </button>
            ...
            <div className="space-y-4">
              ...
              <Card className="rounded-3xl border border-[#2b2d31] bg-[#2b2c2f] text-white shadow-none">
                ...
                <p className="mt-2 text-sm leading-relaxed text-[#ece7db]">
                  異쒖꽍瑜좎씠 ?섎씫?섎뒗 ?섍컯?앹? 二?1??泥댄겕?멸낵 怨쇱젣 ?쇰뱶諛?猷⑦봽瑜?                  媛뺥솕?섎㈃ ?숈뒿 ?좎??⑥씠 媛쒖꽑?⑸땲??
                </p>
              </Card>
              <Card className="rounded-3xl border border-[#e1ddd6] bg-[#f8f7f4] shadow-none">
