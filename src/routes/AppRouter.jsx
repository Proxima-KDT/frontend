...
const ProblemManagement = lazy(() => import('@/pages/teacher/ProblemManagement'))
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route path="/student/problems" element={<ProtectedRoute role="student"><ProblemList /></ProtectedRoute>} />
        <Route path="/student/problems/:id" element={<ProtectedRoute role="student"><ProblemDetail /></ProtectedRoute>} />
        <Route path="/student/voice-feedback" element={<ProtectedRoute role="student"><VoiceFeedback /></ProtectedRoute>} />
        <Route path="/student/mock-interview" element={<ProtectedRoute role="student"><MockInterview /></ProtectedRoute>} />
        <Route path="/student/jobs" element={<ProtectedRoute role="student"><JobMatching /></ProtectedRoute>} />
        ...
        <Route path="/student/equipment" element={<ProtectedRoute role="student"><StudentEquipment /></ProtectedRoute>} />

        {/* Teacher */}
        <Route path="/teacher" element={<ProtectedRoute role="teacher"><TeacherDashboard /></ProtectedRoute>} />
        <Route path="/teacher/students/:id" element={<ProtectedRoute role="teacher"><StudentDetail /></ProtectedRoute>} />
        <Route path="/teacher/questions" element={<ProtectedRoute role="teacher"><TeacherQuestions /></ProtectedRoute>} />
        <Route path="/teacher/counseling" element={<ProtectedRoute role="teacher"><Counseling /></ProtectedRoute>} />
        <Route path="/teacher/problems" element={<ProtectedRoute role="teacher"><ProblemManagement /></ProtectedRoute>} />

        {/* Admin */}
        <Route path="/admin" element={<ProtectedRoute role="admin"><AdminDashboard /></ProtectedRoute>} />
        <Route path="/admin/equipment" element={<ProtectedRoute role="admin"><EquipmentManagement /></ProtectedRoute>} />
