    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        ...
        <Card>
          ...
          <p className="text-h2 font-bold text-warning-600">{unansweredCount}건</p>
        </Card>
        <Card>
          <p className="text-caption text-gray-500 mb-1">답변완료</p>
          <p className="text-h2 font-bold text-success-600">{answeredCount}건</p>
        </Card>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-body-sm font-medium text-gray-500">작성자</span>
                {selectedQuestion.is_anonymous ? (
                  <span className="text-body-sm text-gray-400 italic">익명</span>
                ) : (
                  <span className="text-body-sm text-gray-700">{selectedQuestion.author}</span>
                )}
