...
export default function AdminRoomReservation() {
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#f0ede8] bg-[#fbfaf7] px-4 py-3">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <span className="text-xs font-medium text-[#9c988e]">범례:</span>
              {[
          ...
          <div className="overflow-x-auto">
            ...
            >
              <thead>
                ...
                {activeTab === 'all' && (
                  <tr>
                    <th className="sticky left-0 z-10 w-20 min-w-20 border-b border-r border-[#eceae4] bg-white" />
      ...
      <div>
        <h2
          className={`mb-3 text-[1.7rem] font-semibold text-[#2c2b28]`}
        >
          방 정보
        </h2>
        {activeTab === 'all' ? (
