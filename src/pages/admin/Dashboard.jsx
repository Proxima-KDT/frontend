          ...
          <div className="flex items-center gap-3">
            <div className="relative w-72">
              ...
              <input
                ...
                className="h-10 w-full rounded-full border border-[#e2dfd8] bg-[#f8f7f4] pl-9 pr-4 text-sm outline-none transition focus:border-[#2d2d2d] focus:ring-1 focus:ring-[#2d2d2d]"
              />
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <Card className="rounded-3xl border border-[#e1ddd6] bg-[#f8f7f4] shadow-none">
            ...
            <div className="grid grid-cols-[44px_minmax(0,1.3fr)_80px_110px_100px] items-center gap-3 px-3 pb-2 text-[10px] font-semibold uppercase tracking-[0.08em] text-[#9e9890]">
              <div />
              <button
                className="flex items-center gap-0.5 transition hover:text-[#2d2d2d]"
                onClick={() => {
                  if (sortKey === 'name')
              ...
              {recentStudents.map((student) => {
                ...
                return (
                  ...
                  >
                    <Avatar
                      name={student.name}
                      src={student.avatar_url ?? student.avatarUrl ?? undefined}
                      size="md"
